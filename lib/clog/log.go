// Package clog provides the shared logrus logger used across abs-mcp.
//
...
func createLogger() *logrus.Logger {
	...
	if err != nil {
		...
		l.Errorf("defaulting to TRACE: unable to parse `ABS_LOG` into a valid log level %v", err)
	} else {
		l.SetLevel(ll)
	}
